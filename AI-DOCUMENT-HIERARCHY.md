...
| **2** | **Sprints WEBSITE na ordem de criação** — WEBSITE 1 (Arquitetura) → WEBSITE 2 (Filosofia, Experiência, Motion) → WEBSITE 2.5 (Benchmark, Catálogo, DNA) → WEBSITE 3 (Foundation, Layout, Tipografia) → WEBSITE 4 (Conteúdo, Conversão, Storytelling, Tom) → WEBSITE 5 (Creative Brief executivo) → WEBSITE 6 (Art Direction Master — Baseline de Direção de Arte) | Fonte das decisões; cada sprint só pode detalhar, nunca contradizer as anteriores |
| **3** | **WEBSITE 4.5 — Creative Brief Master** (consolidação de toda a estratégia de criação) + **Moodboards** (direções conceituais A/B/C) + **Claude Design Brief** (contrato de trabalho da exploração) + **Design Checklist** (validação eliminatória). O **Creative Freeze** permanece como processo de governança de mudanças | Consolidação oficial da fase de planejamento; dentro do grupo 4.5, o documento próprio prevalece sobre a seção correspondente do Master (checklist sobre a seção de checklist); a origem (níveis 1 e 2) vence em divergência |
